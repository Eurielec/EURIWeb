    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500 font-sans">
      <header>
        <h1 className="text-5xl font-black text-red-600 uppercase tracking-tighter italic">
          {isAdmin ? 'Administration' : 'Vocalia Panel'}
        </h1>
        <p className="text-gray-400 mt-3 text-lg font-medium">
          {isAdmin 
            ? 'Panel de control global de la asociación. Gestión técnica y operativa.' 
            : 'Panel de gestión para vocalías y proyectos.'}
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {isAdmin ? (
          <>
            <div className="bg-neutral-900/40 backdrop-blur-xl p-6 rounded-3xl border border-white/5 shadow-2xl hover:border-red-600/30 transition-all duration-300 group">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Total Usuarios</p>
            ...
            <div className="bg-neutral-900/40 backdrop-blur-xl p-6 rounded-3xl border border-white/5 shadow-2xl hover:border-red-600/30 transition-all duration-300 group">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Administradores</p>
          ...
          <>
             <Link href="/admin/projects" className="bg-neutral-900/40 backdrop-blur-xl p-6 rounded-3xl border border-white/5 shadow-2xl hover:border-red-600/30 transition-all duration-300 group text-left">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Proyectos Activos</p>
            ...
            <Link href="/admin/events" className="bg-neutral-900/40 backdrop-blur-xl p-6 rounded-3xl border border-white/5 shadow-2xl hover:border-red-600/30 transition-all duration-300 group text-left">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Gestión de Eventos</p>
                  <h3 className="text-lg font-black text-white mt-4 group-hover:text-red-600 transition-colors uppercase tracking-tight">Organizar Reunión</h3>
                </div>
                <div className="p-3.5 bg-red-600/10 rounded-2xl group-hover:bg-red-600/20 transition-colors">
        ...
        <div className="bg-neutral-900/40 backdrop-blur-xl p-6 rounded-3xl border border-white/5 shadow-2xl hover:border-red-600/30 transition-all duration-300 group">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Estado Sistemas</p>
      ...
      {isAdmin && (
        <div className="bg-neutral-900/40 backdrop-blur-xl rounded-3xl border border-white/5 shadow-2xl overflow-hidden">
          <div className="p-8 border-b border-white/5 bg-black/20">
            <h2 className="text-xl font-black text-white uppercase tracking-tighter">Últimos Socios Registrados</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-300">
              <thead className="text-[10px] text-gray-500 uppercase font-black tracking-widest bg-black/40">
                <tr>
                  <th className="px-8 py-5">Email del Usuario</th>
              ...
              <tbody className="divide-y divide-white/5">
                ...
                {recentUsers.length === 0 && (
                  <tr>
                    <td colSpan={3} className="px-8 py-10 text-center text-gray-500">Ningún usuario encontrado en la base de datos.</td>
                  </tr>
                )}
              </tbody>
            </table>
      ...
      {!isAdmin && (
        <div className="grid grid-cols-1 gap-6">
           <div className="bg-neutral-900/40 backdrop-blur-xl p-8 rounded-3xl border border-white/5 shadow-2xl flex flex-col items-center justify-center text-center space-y-4">
              ...
              <h2 className="text-2xl font-bold text-white">Panel de Vocalía Activo</h2>
              <p className="text-gray-400 max-w-md">
                Como Vocal, tienes permisos para gestionar los proyectos de tecnología y coordinar eventos en el calendario. Las funciones de administración de usuarios están reservadas a la Junta Directiva.
              </p>
           </div>
        </div>
      )}
