        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-neutral-900 border border-white/5 rounded-[3rem] w-full max-w-5xl max-h-[85vh] flex flex-col overflow-hidden shadow-[0_0_100px_rgba(232,22,27,0.1)] font-sans"
            >
              <header className="p-10 border-b border-white/5 flex items-center justify-between shrink-0 bg-black/40">
                <div>
                ...
                <button onClick={() => setIsOpen(false)} className="p-4 rounded-2xl bg-white/5 hover:bg-red-600 hover:text-white text-gray-500 transition-all">
                  <X />
                </button>
              </header>
              ...
              <div className="flex-1 overflow-y-auto p-10 space-y-6 custom-scrollbar">
                {loading ? (
                  ...
                  <>
                    <div className="grid grid-cols-12 gap-6 text-[10px] font-black uppercase tracking-widest text-gray-600 px-4 pb-2 border-b border-white/5">
                    ...
                    <div className="space-y-3">
                      {variants.map((v, i) => (
                        <div key={i} className="grid grid-cols-12 gap-4 items-center bg-white/[0.02] p-3 rounded-2xl border border-white/5 hover:border-white/10 transition-colors">
                          <div className="col-span-2">
                            <input
                              ...
                              placeholder="S, M..."
                              className="w-full bg-black/60 border border-white/5 rounded-xl px-4 py-3 text-xs text-white focus:outline-none focus:border-red-600 font-bold"
                            />
                          </div>
                          <div className="col-span-2">
                            <input
                            ...
                            <>
                              <div className="col-span-2">
                                <select
                                  ...
                                  className="w-full bg-black/60 border border-white/5 rounded-xl px-4 py-3 text-[10px] font-black uppercase text-white focus:outline-none focus:border-red-600"
                                >
                          ...
                          <div className={isHoodie ? 'col-span-2' : 'col-span-6'}>
                            <input
                              ...
                              className="w-full bg-black/60 border border-white/5 rounded-xl px-4 py-3 text-sm font-black text-white focus:outline-none focus:border-red-600 text-center"
                            />
                          </div>
                          <div className="col-span-2 flex justify-end">
                            <button
                              onClick={() => removeVariant(i)}
                              className="p-3 text-gray-600 hover:text-red-600 hover:bg-red-600/10 rounded-xl transition-all"
                            >
                              <Trash2 size={18} />
                            </button>
                          </div>
                    ...
                    <button
                      onClick={addVariant}
                      className="w-full py-6 border-2 border-dashed border-white/5 rounded-3xl flex items-center justify-center gap-3 text-gray-600 hover:text-white hover:border-red-600/40 transition-all font-black text-[10px] uppercase tracking-[0.3em] bg-white/[0.01]"
                    >
              ...
              <footer className="p-10 border-t border-white/5 bg-black/40 flex justify-end gap-6 shrink-0">
                <button
                ...
                <button
                  onClick={save}
                  disabled={saving}
                  className="flex items-center gap-3 px-12 py-4 rounded-2xl bg-red-600 hover:bg-red-700 text-white text-[10px] font-black uppercase tracking-[0.2em] transition-all shadow-xl shadow-red-600/20 disabled:opacity-50"
                >
